...
export default function BundleModal({ isOpen, onClose, bundleName, skins }: BundleModalProps) {
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-4 left-6 right-6">
                  <h2 className="text-3xl font-bold text-white drop-shadow-md">{bundleName}</h2>
                  <p className="text-gray-300 mt-1">{skins.length} skins disponibles</p>
                </div>
                  ...
                  {skins.map((skin, index) => (
                    ...
                    >
                      ...
                      <div className="p-4 border-t border-gray-700">
                        <h3 className="text-white font-medium text-center">{skin.skinName}</h3>
                      </div>
                    </motion.div>
                  ))}
                </div>
