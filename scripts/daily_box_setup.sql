-- Script para configurar la funcionalidad de la caja diaria
...
-- 2. Función para actualizar la caja diaria a las 9:00 AM
...
-- 3. Función para forzar la actualización de la caja diaria (para pruebas)
...
-- 4. Programar la actualización automática a las 9:00 AM todos los días

-- Nota: Esta parte requiere permisos de superusuario en PostgreSQL
-- Si estás usando Supabase, puedes configurar un cron job en su plataforma
...
SELECT cron.schedule(
  ...
  '0 9 * * *',  -- Ejecutar a las 9:00 AM todos los días
